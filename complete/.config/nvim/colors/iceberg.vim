...
if &background == 'light'
  ...
  hi StatusLine cterm=reverse ctermbg=234 ctermfg=245 guibg=NONE guifg=#818596 term=reverse
  " hi StatusLineTerm cterm=reverse ctermbg=234 ctermfg=245 gui=reverse guibg=#17171b guifg=#818596 term=reverse
  hi StatusLineTerm cterm=reverse ctermbg=234 ctermfg=245 guibg=NONE guifg=#818596 term=reverse
